                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex h-16 items-center justify-between">
                        ...
                        <nav className="hidden md:flex items-center gap-8">
                            ...
                            <Link className="text-sm font-semibold hover:text-primary transition-colors" href="/how-it-works">How it Works</Link>
                            <Link className="text-sm font-semibold hover:text-primary transition-colors" href="/about">About</Link>
                            <Link className="text-sm font-semibold hover:text-primary transition-colors" href="/partner">Partner Program</Link>
                        </nav>
                        <div className="flex items-center gap-3">
                            <Link href="/partner">
                                <button className="hidden sm:flex items-center gap-2 px-4 py-2 text-sm font-bold bg-white/10 dark:bg-slate-800 hover:bg-white/20 dark:hover:bg-slate-700 border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-200 rounded-xl transition-all uppercase tracking-wider">
                                    List Your Fleet
                                </button>
                            </Link>
                            <Link href="/post-requirement">
                                <button className="flex items-center gap-2 px-5 py-2 text-sm font-bold bg-primary text-white rounded-xl hover:shadow-lg hover:shadow-primary/20 transition-all uppercase tracking-wider">
                                    Post Requirement
                                </button>
                            </Link>
                        </div>
            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="mb-12 text-center md:text-left">
                    <h1 className="text-4xl md:text-5xl font-extrabold text-slate-900 dark:text-white mb-4">
                        Premium Industrial <span className="text-primary">Fleet Catalog</span>
                    </h1>
                    <p className="text-lg text-slate-600 dark:text-slate-400 max-w-2xl">
                        Access 5,000+ verified heavy machines across 200 cities. Rent with confidence, operator included.
                    </p>
                </div>
                        ...
                        <div key={idx} className="group bg-white dark:bg-slate-900 rounded-2xl overflow-hidden border border-slate-200 dark:border-slate-800 hover:border-primary/50 transition-all hover:shadow-xl cursor-pointer">
                            <Link href={`/equipment/${machine.id}`}>
                                ...
                                <div className="p-4">
                                    ...
                                    <button className="w-full py-2 bg-slate-900 dark:bg-slate-800 hover:bg-primary text-white rounded-lg text-sm font-bold flex items-center justify-center gap-2 transition-colors">
                    ...
                    <div className="relative z-10 max-w-4xl mx-auto grid md:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <p className="text-slate-400 mb-8 leading-relaxed">
                                Can't find what you're looking for? Tell us your project needs and our vendor network will find the best match for you.
                            </p>
                        ...
                        <form className="space-y-4 bg-white p-8 rounded-2xl text-slate-900">
                            ...
                            <div className="space-y-1">
                                ...
                                <textarea className="w-full bg-slate-100 border-none rounded-lg focus:ring-primary transition-all p-3 outline-none" placeholder="Describe the machine type, duration and work details..." rows={3}></textarea>
                            </div>

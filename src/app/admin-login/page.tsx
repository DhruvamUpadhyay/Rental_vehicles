                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl pl-10 pr-4 py-3 focus:ring-2 focus:ring-primary focus:border-primary outline-none tracking-widest font-bold disabled:opacity-50 text-slate-900 dark:text-white"
                                    placeholder="••••••••••"
                                    disabled={loading}
                                />
                            </div>
